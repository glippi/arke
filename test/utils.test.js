...
describe('exec command with cli flags', () => {
  describe('getRepoCreationDateFor', () => {
    ...
    .it('returns created_at field with value 2020-02-29T10:28:16Z', async () => {
      const creationDate = await getRepoCreationDateFor('glippi/arke')
  ...
  describe('getFirstCommitUrlFor', () => {
    ...
    .it('returns the url pointing to github with first commit', async () => {
      const url = await getFirstCommitUrlFor('glippi/arke/2020-02-29T10:28:16Z')

      expect(url).to.equal('https://github.com/glippi/arke/commit/f620e8b88ef042853fadb83e2d99ff8cce5dbf43')
    })
  })
})
